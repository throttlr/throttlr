...
import io.github.throttlr.twitter.wrapper.*;
import twitter4j.*;
...
public class ThrottlrTwitter implements Twitter {
    ...
    public ThrottlrTwitter(Twitter twitter, ThrottleStrategy throttleStrategy) {
        ...
        this.searchResource = new SearchResourceWrapper(twitter.search(), throttleStrategy);
        this.directMessagesResources = new DirectMessagesResourcesWrapper(twitter.directMessages(), throttleStrategy);
        this.friendsFollowersResources = new FriendsFollowersResourcesWrapper(twitter.friendsFollowers(), throttleStrategy);
        this.usersResources = new UsersResourcesWrapper(twitter.users(), throttleStrategy);
        this.suggestedUsersResources = new SuggestedUsersResourcesWrapper(twitter.suggestedUsers(), throttleStrategy);
        this.favoritesResources = new FavoritesResourcesWrapper(twitter.favorites(), throttleStrategy);
        this.listsResources = new ListsResourcesWrapper(twitter.list(), throttleStrategy);
        this.savedSearchesResources = new SavedSearchesResourcesWrapper(twitter.savedSearches(), throttleStrategy);
        this.placesGeoResources = new PlacesGeoResourcesWrapper(twitter.placesGeo(), throttleStrategy);
        this.trendsResources = new TrendsResourcesWrapper(twitter.trends(), throttleStrategy);
        this.spamReportingResource = new SpamReportingResourceWrapper(twitter.spamReporting(), throttleStrategy);
        this.helpResources = new HelpResourcesWrapper(twitter.help(), throttleStrategy);
    }
